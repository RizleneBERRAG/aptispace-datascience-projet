...
- notebooks/ (Les notebooks guidés des jalons)
    - [01_data_wrangling.ipynb](lab/projet/notebooks/01_data_wrangling.ipynb)
    - [02_eda_visualisation.ipynb](lab/projet/notebooks/02_eda_visualisation.ipynb)
    - [03_modelisation_pred.ipynb](lab/projet/notebooks/03_modelisation_pred.ipynb)
    - [04_vision_cnn_tf.ipynb](lab/projet/notebooks/04_vision_cnn_tf.ipynb)
